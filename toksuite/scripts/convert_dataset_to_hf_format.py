...
from toksuite.utils.utils import find_package_dir

LM_EVAL_PKG_DIR = Path(find_package_dir("lm_eval"))
# Usage:
# python toksuite/scripts/convert_dataset_to_hf_format.py toksuite/configs/tokenization_robustness/v101/convert_v103_to_lm_eval.yaml
# python toksuite/scripts/convert_dataset_to_hf_format.py toksuite/configs/tokenization_robustness/v101/convert_v102_to_lm_eval.yaml
# python toksuite/scripts/convert_dataset_to_hf_format.py toksuite/configs/tokenization_robustness/v101/convert_v101_to_lm_eval.yaml
# python toksuite/scripts/upload_dataset_to_hf.py --input_dir=data/v101 --upload_all=true --private=false --is_translation=false  --upload_individually=false
