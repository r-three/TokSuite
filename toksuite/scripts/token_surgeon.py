...
# python toksuite/scripts/token_surgeon.py "/model-weights/Qwen2.5-7B-Instruct"  "/model-weights/Meta-Llama-3.1-8B-Instruct" /checkpoint/$USER/$SLURM_JOB_ID/surgeon/llama-to-qwen --allow-crimes --push-to-hub --cuda --read-to-gpu
# 16050060
# sbatch --time 120 --mem 32G --qos m2 -p a40 --gres=gpu:a40:1 --wrap="python toksuite/scripts/token_surgeon.py  "/model-weights/Meta-Llama-3.1-8B-Instruct"  "/model-weights/Qwen2.5-7B-Instruct" /checkpoint/$USER/$SLURM_JOB_ID/surgeon/qwen-to-llama --allow-crimes --push-to-hub --cuda --read-to-gpu"
# python toksuite/scripts/token_surgeon.py "/model-weights/Qwen2.5-3B-Instruct" "/model-weights/Qwen2.5-7B-Instruct"    $SCRATCH/surgeon
