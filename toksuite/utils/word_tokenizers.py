...
from toksuite.utils._import_utils import ASSETS_PATH, check_required_dependencies
from toksuite.utils.text import TERMINAL_PUNCTUATION
...
class SpaCyTokenizer(WordTokenizer):
    ...
    def tokenizer(self):
        if self._tokenizer is None:
            ...
            from toksuite.utils.japanese_tokenizer import JapaneseTokenizer  # noqa: F401
